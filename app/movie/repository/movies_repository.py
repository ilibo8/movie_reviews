...
class MovieRepository:
    ...
    def get_movies_by_director(self, director: str) -> list[Type[Movie]]:
        ...
        """
        return self.db.query(Movie).filter(Movie.director.contains(director)).all()
    ...
    def get_movies_by_release_year(self, release_year: int) -> list[Type[Movie]]:
        ...
        """
        return self.db.query(Movie).filter(Movie.release_year == release_year).all()
    ...
    def get_movies_by_country_of_origin(self, country_of_origin: str) -> list[Type[Movie]]:
        ...
        """
        return self.db.query(Movie).filter(Movie.country_of_origin == country_of_origin).all()
