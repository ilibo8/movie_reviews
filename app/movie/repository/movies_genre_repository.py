...
class MovieGenreRepository:
    ...
    def get_all_movie_ids_of_certain_genre(self, genre_name: str) -> list[int]:
        ...
        genre. It does this by querying the MovieGenre table for all rows where the genre_name matches what was passed in,
        and then returning a list of those movie ids.
        """
